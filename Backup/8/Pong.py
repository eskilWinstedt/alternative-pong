...
def mainLoop():
	...
	activeLoops = {'gameIntro': True, 'pause': False, 'game': False, 'FPSMeter': False, 'modesScreen': False, 'pause': False, 'reallyExitPopup': False}
	background = colors.black
	buttonFontSize = dim['button_font_size_y']
	buttonColorScheme = (colors.white,colors.grey,colors.der_Grey,colors.grey, colors.black)
	...
	while  not loopExit:
		...
		timeMultipiler = timeMultipiler * 4
