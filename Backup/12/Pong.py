...
def mainLoop():
	...
	while  not loopExit:
		...
		if activeLoops['settings']:
			...
			if fullscreenToggleButton.updateButton([dim['fullscreen_button_pos_x'], dim['fullscreen_button_pos_y']], True):
