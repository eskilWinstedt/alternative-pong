...
class CreateSelector(object): #A text with two buttons on either side. < text > The text is the value that you select
	...
	def update(self):
		...
		textToScreen(self.values[self.selectedValue], colors.white, self.fontSize, self.textPos[0], self.textPos[1], (True, True), standardFont)  #FORTSÄTT HÄR 
def livesToScreen():
